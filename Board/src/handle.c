...
uint32 Servo_value=9234;//舵机输出pwm值
uint32 Servomiddle=9234;
uint32 Servo_max=9368; 
uint32 Servo_min=9100;
  ...
  for(Row=15;Row<59;Row++) 
{
  ...
  if(J2==1&&All_Black==0&&K1==0&&K2==0&&Cross_Flag==0)
  {
              ...
              Servo_value=(int)(Servomiddle-Servo_t);
  ...
  else if(J1==1&&All_Black==0&&K1==0&&K2==0)
  {
              ...
              Servo_value=(int32)(Servomiddle+Servo_t);
