...
{    
    ...
    GPIO_QuickInit(OLED_DC_PORT,OLED_DC_PIN,kGPIO_Mode_OPP);//初始化DC口  
    GPIO_QuickInit(OLED_RST_PORT,OLED_RST_PIN,kGPIO_Mode_OPP);//初始化RST  
